        ...
        messages=[
          {
            ...
            "content": [
                ...
                {"type": "text", "text": "Return an HTML table with data. Only return HTML not other text. Do not try to read text inside images. Keep the original language. Try to break the text into semantically meaningful sections. Use the following HTML structure for the output: <table><tr><td>Section Title</td><td>Section Text</td></tr><tr><td>Section Title</td><td>Section Text</td></tr></table>"},
                {"type": "text", "text": "If the image contains partial pages ignore them and all the text in them."},
                {"type": "text", "text": "If the text contains foreign letters like accents (examples: à, è, ì, ć, č, ž) please keep them as is and do not convert them to Unicode codes like '\u00f3'."},                
